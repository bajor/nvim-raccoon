...
### Fixed
- Enable `core.longpaths` for all git operations, fixing "unable to create file, filename too long" errors on Windows when cloning repos with deeply nested paths
