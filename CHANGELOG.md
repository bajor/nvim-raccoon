...
- Replace double-width emoji (`💬`, `⛔`, `⚠`) with ASCII equivalents (`>>`, `!!`) in signs, statusline, and virtual text — fixes broken rendering and misaligned sign columns on Windows terminals
