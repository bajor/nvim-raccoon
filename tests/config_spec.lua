...
describe("raccoon.config", function()
  ...
  describe("create_default", function()
    it("creates default config file", function()
      ...
      file:close()
      assert.truthy(content:find('"your%-username"', 1, false))
      assert.truthy(content:find('"clone_root"', 1, true))
      local decoded = vim.json.decode(content)
      assert.equals("github.com", decoded.github_host)
      assert.equals("ghp_xxxxxxxxxxxxxxxxxxxx", decoded.tokens["your-username"])
